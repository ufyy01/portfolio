						...
						<DrawerDescription className="w-11/12 mx-auto  text-white text-start">
							<div className=" flex flex-col ">
								...
								<p className="text-start text-pretty  text-white my-5 text-lg">
									...
									development, design, and problem-solving. Stay tuned for
									updates as I continue to develop these projects and bring them
									to life!
								</p>
							</div>
							<div className="space-y-4 bg-white/20 backdrop-blur-md rounded-lg p-5 shadow-lg border border-white/30 z-[1000]">
								...
								<p className="text-start my-5 text-lg">
									...
									provides a serene and user-friendly experience where
									individuals can reflect on scripture, record thoughts, and
									organize their spiritual journey.
								</p>
								<p className="text-start my-5 text-lg text-orange-200">
									<span className="font-fraunces italic text-[#fc045c]">
										Technology Stack:
									</span>{" "}
									React Native, Expo, Skia, Zustand, TypeScript, Node.js,
									Express, MongoDB
								</p>
								<Button
									size="lg"
								...
								<p className="text-start my-5 text-lg">
									...
									of Lagos, Nigeria. You play as a young Nigerian man who lost
									his last cash to a danfo conductor and must chase the bus
									through Lagos, navigating vibrant streets, dangerous
									shortcuts, and hilarious obstacles.
								</p>
								<p className="text-start my-5 text-lg text-orange-200">
									<span className="font-fraunces italic text-[#fc045c]">
										Technology Stack:
